...
<!--                                    <form class="form-horizontal">-->
                                        <div class="form-group has-success">
                                            ...
                                            <form name="sentMessage"  action="userverification" method="post" enctype="multipart/form-data">


                                                <label><input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <span class="label ">Username/Email*</span></label>
                                                    
                                                    <br>
                                                    
                                                <input type="email"  placeholder="username"  class="form-control" id="username" name="username" value="{{ old('username') }}">
                                                
                                                <div class="error">{{ $errors->first('username') }}<br />
