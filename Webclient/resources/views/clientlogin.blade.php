        ...
        <div class="header">
            <div class="container">
                <div class="header-grids">
                    <div class="logo">
                        <h1><a  href="index.html"><span>CloudViews - Login</span></a></h1>
                    </div>
                    <!--navbar-header-->
...
<!--                                    <form class="form-horizontal">-->
                                        <div class="form-group has-success">
                                            ...
                                            <form name="sentMessage"  action="clientlogin" method="post" enctype="multipart/form-data">
...
<div class="form-group">
                            <button type="submit" name="submit" class="btn btn-primary btn-sm" required="required">Login</button>
                        </div>
                     <div class="center">  
                         <span class="label">forgot password?</span> <a href="clientpassword">click here</a><br>
