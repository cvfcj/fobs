        ...
        <div class="header">
            <div class="container">
                <div class="header-grids">
                    <div class="logo">
                        <h1><a  href="index.html"><span>CloudViews - Registration</span></a></h1>
                    </div>
                    <!--navbar-header-->
                            ...
                            <div class="online_reservation">
                                <div class="b_room col-md-8 col-md-offset-2">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <form name="sentMessage"  action="clientregistration" method="post" enctype="multipart/form-data">
                                            ...
                                            @end if    
                                               ...
                                               <option  value="Afghanistan">Afghanistan</option>
                                                ...
                                                <label>
                                                    <span class="label ">Email*</span></label><br>
