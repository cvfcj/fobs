        ...
        <div class="col-md-12 banner-right">
            <div class="sap_tabs">	
                <div class="booking-info about-booking-info">
                    <h2 style="text-align: center;">Registration Success</h2>
                      <p class="lead" style=" text-align:center;color:#fff">Your registration has been done successfully.Please check your email for confirmation</p>
                </div>
