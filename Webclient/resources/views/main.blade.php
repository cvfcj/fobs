        ...
        <div class="header">
            <div class="container">
                ...
                <div class="nav-top">
                    ...
                    <li class="active">
                        <a href="{{ env('USER_URL') }}/userregistration">User Registration</a>
                    </li>
                    <li class="active">
                        <a href="{{ env('USER_URL') }}/userlogin">User Login</a>
                    </li>
                    <li class="active">
                        <a href="registration">Client Registration</a>
                    </li>
                    <li class="active">
...
<!--                                            <form name="sentMessage"  action="registration" method="post" enctype="multipart/form-data">
                                                ...
                                                <select id="country" class="form-control" selected="selected" value="{{ old('country') }}">
                                                    ...
                                                    <option  value="BahrainBahrain</option>
                                                ...
                                                <div class="error">{{ $errors->first('phone') }}</div><br />
                                                <label>
