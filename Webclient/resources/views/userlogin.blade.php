...
<!--                                    <form class="form-horizontal">-->
                                        <div class="form-group has-success">
                                            ...
                                            <form name="sentMessage"  action="userlogin" method="post" enctype="multipart/form-data">
...
<div class="form-group">
                     ...
                     <div class="center">  
                         <span class="label">forgot password?</span> <a href="userpassword">click here</a><br>
