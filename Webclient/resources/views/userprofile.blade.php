                    ...
                    <div class="facts about-facts train-facts">
                        <div class="booking-form train-form">
                            ...
                            <div class="online_reservation">
                                ...
                                <form name="sentMessage" id="contactForm" action="userprofile" method="post">
                                

                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <label>
                                        <span class="label">Email Address</span></label>
                                    <input type="email" readonly="readonly" class="form-control" placeholder="Email Address" id="username" name="username" value="{{ $username }}">
