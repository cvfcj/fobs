...
<html>
    <head>
        <title>CloudViews - Registration</title>
        <!-- Custom Theme files -->
        ...
        <div class="header">
            <div class="container">
                <div class="header-grids">
                    <div class="logo">
                        <h1><a  href="index.html"><span>CloudViews - UserRegistration</span></a></h1>
                    </div>
                    <!--navbar-header-->
                            ...
                            <div class="online_reservation">
                                <div class="b_room col-md-8 col-md-offset-2">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <form name="sentMessage"  action="userregistration" method="post" enctype="multipart/form-data">
<!--                                                <label>                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <span class="label">Organization*</span></label><br>
                                                <input type="text"  class="form-control" placeholder="Name of the organization" id="organization" name="organization" value="{{ old('organization') }}">

                                                <div class="error">{{ $errors->first('organization') }}</div><br />-->
                                                              
                                                    <label>
                                                    <span class="label ">Username/Email*</span></label><br>
                                                <input type="email"  placeholder="email"  class="form-control" id="username" name="username" value="{{ old('username') }}">
                                                ...
                                                <label>
                                                    <span class="label ">Phone Number</span></label><br>
                                                <input type="text"  placeholder="phone"  class="form-control" id="phonenumber" name="phonenumber" value="{{ old('phonenumber') }}">

                                                <div class="error">{{ $errors->first('phonenumber') }}</div><br />
                                                <label>             <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <span class="label ">Country*</span></label><br>
                                                <select    placeholder="country"  class="form-control" id="country" name="country" value="{{ old('country') }}">
                                               
                                                      @if (old('country'))
                                            <option selected="selected" value="{{ old('country') }}">{{ old('country') }}</option>
                                         
                                            @else
                                               <option  selected="selected" value="">Select Country</option>                                            @endif   
                                            @end if  <option  value="Afghanistan">Afghanistan</option>
                                               ...
                                               <div class="error">{{ $errors->first('country') }}</div><br />
                                                ...
                                                <button id="myButton" type="submit"  class="btn btn-primary">Signup</button>
                                        </div>
                                    </form>
                                    <div class="clearfix"></div>
                                </div>
