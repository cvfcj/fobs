            ...
            <div class="container">
                ...
                <div class="nav-top">
                    <div class="top-nav">
                        ...
                        <ul class="nav1">
                            <li >
                                <a href="{{ env('USER_URL') }}/home">Home</a>
                            </li>
                            <li class="active">
                                <a href="about.html">Verification</a>
                            </li>
                            <!--                            <li class="active">
                            ...
                            <div class="online_reservation">
                                <div class="b_room col-md-6 col-md-offset-2">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="clientconfirmation">

                                            <label>
                                                <span class="label ">Verification Code*</span></label>
  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <br>

                                            <input type="verification"  placeholder="verification"  class="form-control" id="verification" name="verification" value="{{ old('verification') }}">

                                            <div class="error">{{ $errors->first('verification') }}<br />
                                                <!--<button type="submit" name="Submit" class="btn btn-primary btn-sm" required="required">Submit Your Email</button></div>-->
                                            <button type="submit" name="submit"  class="btn btn-primary btn-sm" required="required">Verify Code</button>
                                            <br />
